...
//const botrole_ID= "241599516065660930";
//const SPB_generalID = "240843640375607296"
...
client.on('ready', async () => {
  ...
  console.log('Choosing random person to t!daily...');
  var chosenid = chooseRand(obj_members).id;
  client.channels.get(SPB_ServID).sendMessage('t!dailies <@'+chosenid+'>');
  //client.destroy();
  //process.exit();
